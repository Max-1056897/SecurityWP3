...
c.execute("INSERT INTO leerlingen (naam, gebruikersnaam, wachtwoord, rooster) VALUES ('Leerling 1', 'admin', 'admin', 'Klas 1A')")
c.execute("INSERT INTO leerlingen (naam, gebruikersnaam, wachtwoord, rooster) VALUES ('Leerling 2', 'admin', 'admin', 'Klas 2B')")
